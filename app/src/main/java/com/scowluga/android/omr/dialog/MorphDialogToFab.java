...
public class MorphDialogToFab extends ChangeBounds {
    ...
    public void captureEndValues(TransitionValues transitionValues) {
        ...
        transitionValues.values.put(PROPERTY_COLOR, ContextCompat.getColor(view.getContext(), MainActivity.Companion.isAddBtnClick() ? R.color.addBtn_background_color : R.color.fab_background_color));
